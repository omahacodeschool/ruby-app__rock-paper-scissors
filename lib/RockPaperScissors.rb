class Game
  ...
  def setup
   ...
   # player1value allows tests to call Player1
   #=> NIL, unless used with set_player1value
  def player1value
    return @Player1
  end
  # set_player1value gives @Player1 a value OUTSIDE GAMEPLAY
  #banana--a string you would like to name @Player1
  #=> a name for @Player1
